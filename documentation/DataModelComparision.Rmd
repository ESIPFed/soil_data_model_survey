...
```{r allDM, fig.cap='Figure 1: Data models with id keys only.'}
...
```{r CrowtherDM, fig.cap='Figure 2: Crawther data model. An example of a less complex, single PI data model.'}
...
```{r vanGestelDM, fig.width=8, fig.height=24, fig.cap='Figure 3: ISRaD data model. An example of a complex, multiPI data model.'}
