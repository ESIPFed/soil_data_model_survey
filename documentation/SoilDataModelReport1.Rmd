...
The primary goal of this project was to survey the different data models used by soil carbon meta-analysis.
...
Some of these studies were ongoing pre-publication (CCRCN, ISCN), ongoing with incremental publications (ISRaD:@Lawrence2020) and completed projects (Crowther:@Crowther2016, vanGestel:@vanGestel2018).
