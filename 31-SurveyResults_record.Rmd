...
None of the study respondents mentioned DataOne or PI-driven data repositories for data discovery.
...
Unsurprisingly open public data was well supported by the respondents with interest in broadening scientific impact and increased visibility.
Attribution and engagement was a named concern of respondents, in particular collonial science was called out as being particularly problematic.
Time investments with unclear rewards.
Unclear what "data base" was appropriate for a given data set.
