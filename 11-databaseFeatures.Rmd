...
Soil level characteristics are also common across most data products. 
These include bulk density, depth of sample and layer, organic carbon percentage, loss on ignition, sand, silt, clay, and pH. 
Further, vegetation class notes are described frequently, but are not directly comparable across studies.
...
Crowther and Van Gestel’s data models have unique features amongst their many commonalities. 
...
and features updated data from outside sources (Biome, % Clay, pH). Van Gestel categorizes carbon, nitrogen, and phosphorus pools above and below ground, has detailed treatment information, soil horizon, and percent soil organic matter. 
