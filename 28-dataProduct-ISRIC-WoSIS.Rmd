---
title: "ISRIC record"
author: "K Todd-Brown (ktoddbrown@ufl.edu); Niels H. Batjes, Eloi Ribeiro, Kristen Frederick, Marisa Younger"
date: "9/4/2020"
...
## September 2020 interview
  ...
  1) What is the history of ISRIC and WoSIS as a database?
      ...
      - SoilGrids
          + Uses soil profile observations from WoSIS and a stack of environmental co-variates to map the spatial distribution of soil properties
  ...
  3) What decisions did you make to arrive at this workflow?
      ...
      - Inside ISRIC, they did not have one compiled database but there was a need for one that was flexible enough to incorporate all the datasets they had
          + This is how WoSIS came about. Subsequently, data sets shared by the international community were added to WoSIS for standardisation
  ...
  4) How would someone get a copy of the data in this study?
      ...
      - Allow other people to add metadata if they want to be included in the registry
          + Consist of a doi for consistent citation purposes and metadata
          + This data is static
...
Thank you to: Niels H. Batjes, Eloi Ribeiro
