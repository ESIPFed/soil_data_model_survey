...
The soil incubation data base has a unique tree structure instead of a relational database that, in its native form, is represented as follows.
The database is a list of studies. 
...
For the sake of comparison we deconstructed this tree structure and described the SIDb data product downloaded June in 2020 with the following set of relational data tables.
